...
const insertToEditElement = <TInsert, TDelete>(
    source: EditElement<TInsert, TDelete>,
    insert: TInsert,
...
const deleteToEditElement = <TInsert, TDelete>(
    source: EditElement<TInsert, TDelete>,
    del: TDelete,
...
const prevLengthOfTextOperationElementArray = <TInsert, TDelete>(
...
const prevLengthOfTextOperationUnitArray = <TInsert, TDelete>(
...
const nextLengthOfTextOperationUnitArray = <TInsert, TDelete>(
    source: ReadonlyArray<TextOperationUnit<TInsert, TDelete>>,
    factory: Factory<TInsert, TDelete>
) => {
    return source.reduce((seed, elem) => {
...
const invertTextOperationElement = <T1, T2>(
